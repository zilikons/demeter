...
def raster2features(city_shapefile:gpd.GeoDataFrame,
    ...
    raster_cropping(built_tif_path,city_shapefile,f'../raw_data/cropped_tifs/{city_name.lower()}_class_proc.tif')
    raster_cropping(pop_tif_path,city_shapefile,f'../raw_data/raw_ce/{city_name.lower()}_pop_proc.tif')
    city_class = raster2gdf(f'../raw_data/cropped_tifs/{city_name}_class_proc.tif')
    city_pop = raster2gdf(f'../raw_data/cropped_tifs/{city_name}_pop_proc.tif')
